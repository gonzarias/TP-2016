...
public class WeightedGraph<V> extends AbstractGraph<V> {
    ...
    @Override /** Clear the weighted graph */
    public void clear() {
        vertices.clear();
        neighbors.clear();
        queues.clear();
    ...
    @Override /** Add vertices to the weighted graph */
    ...
    public class MST extends Tree {
        private double totalWeight; // Total weight of the tree's edges
    ...
    public ShortestPathTree getShortestPath(int sourceVertex) {
        try{
            // T stores the vertices of paths found so far
            List<Integer> T = new ArrayList<Integer>();
